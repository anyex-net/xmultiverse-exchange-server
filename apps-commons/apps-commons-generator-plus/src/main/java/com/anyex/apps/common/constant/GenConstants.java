package com.anyex.apps.common.constant;
...
public class GenConstants {
     ...
     * 数据库长整型类型
     */
    public static final String[] COLUMN_TYPE_LONG = {"mediumint", "number", "bigint"};

    /**
     * 页面不需要编辑字段
     */
    public static final String[] COLUMN_NAME_NOT_EDIT = {"create_by", "create_time", "delete_flag", "update_by",
            "update_time"};

    /**
     * 页面不需要显示的列表字段
     */
    public static final String[] COLUMN_NAME_NOT_LIST = {"create_by", "delete_flag", "update_by",
            "update_time"};

    /**
     * 页面不需要查询字段
     */
    public static final String[] COLUMN_NAME_NOT_QUERY = {"id", "create_by", "update_by",
            "update_time", "remark"};
     ...
     * 需要
     */
    public static final Integer REQUIRE = 0;
}