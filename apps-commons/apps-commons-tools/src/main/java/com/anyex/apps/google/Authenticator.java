...
public class Authenticator
{
    ...
    {
        if (StringUtils.isBlank(secret) || code == null)
        { return false; }
        StringBuffer buffer = new StringBuffer(CacheConst.GOOGLE_CODE_PERFIX).append(GlobalConst.SEPARATOR).append(code);
        if (StringUtils.isNotBlank(RedisUtils.get(buffer.toString())))
        { return false; }
