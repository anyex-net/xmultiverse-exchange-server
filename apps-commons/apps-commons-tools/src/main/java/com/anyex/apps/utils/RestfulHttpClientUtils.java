...
public class RestfulHttpClientUtils {
    ...
    private RestfulHttpClientUtils() {
    }
     ...
     * @throws IOException
     */
    public static HttpResponse requestGet(String method, String url, Map<String, String> body, Map<String, String> headers) throws IOException {
        return getClient(url).method(method).postParams(body).headers(headers).request();
    }
     ...
     * @version 1.0.1
     */
    public static String urlencode(String uri, Map<String, Object> data) {
    ...
    public static String buildUrlByMap(String url, Map<String, String> map) {
    ...
    public static class HttpClient {
        ...
        private int readTimeout = RestfulHttpClientUtils.readTimeout;
        private int connectTimeout = RestfulHttpClientUtils.connectTimeout;
        ...
        public HttpClient(String url) {
            ...
            initializers = RestfulHttpClientUtils.initializers;
        }
        ...
        public HttpResponse request() throws IOException {
            response = RestfulHttpClientUtils.request(this);
            return response;
        }
    ...
    private static HttpResponse request(HttpClient client) throws IOException {
        ...
        if (METHOD_GET.equalsIgnoreCase(client.getMethod())) {
            if (client.getHeaders().containsKey("Get-Body-Json")) {
                //Get请求 发送请求体
            } else {
                //GET请求，不用发请求体
    ...
    public static void setPoolExecutor(ExecutorService poolExecutor) {
        ...
        if (RestfulHttpClientUtils.poolExecutor != null) {
            RestfulHttpClientUtils.poolExecutor.shutdown();
        }
        RestfulHttpClientUtils.poolExecutor = poolExecutor;
    }
