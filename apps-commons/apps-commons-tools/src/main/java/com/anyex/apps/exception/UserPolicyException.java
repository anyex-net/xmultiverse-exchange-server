 ...
 */
@Data
public class UserPolicyException extends AuthenticationException
{
    ...
    public UserPolicyException(Integer code, String message)
    {
        super(message);
        this.code = code;
        this.error = new ErrorInfo(code, message);
    ...
    public UserPolicyException(Integer code, String message, Object object)
    {
        this(code, message);
        this.object = object;
    }
     ...
     * @author Playguy
     */
    public UserPolicyException(EnumDescribable describable)
    {
     ...
     * @author Playguy
     */
    public UserPolicyException(EnumDescribable describable, Object object)
    {
        super(new StringBuilder("error code: ").append(describable.getCode()).append(", description: ").append(describable.getMessage()).toString());
        this.error = describable;
        this.object = object;
