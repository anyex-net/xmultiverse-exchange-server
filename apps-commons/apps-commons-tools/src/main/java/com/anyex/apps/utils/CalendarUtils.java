...
public class CalendarUtils
{
    ...
    {
        if (StringUtils.equals("week", unit))
        { return new DateTime().minusWeeks(num).millisOfDay().withMinimumValue().getMillis(); }
        if (StringUtils.equals("month", unit))
        { return new DateTime().minusMonths(num).millisOfDay().withMinimumValue().getMillis(); }
...
//        DateTime dateTime = new DateTime(2019,8,1,0,0,0,0);
//        System.out.println(dateTime.toDate().getTime() / 1000);
//    }
}
