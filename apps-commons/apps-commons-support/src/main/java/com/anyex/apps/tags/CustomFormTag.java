//package com.anyex.apps.tags;
//
//import com.anyex.apps.bean.SpringContext;
//import com.anyex.apps.csrf.CSRFDataValueProcessor;
//import com.blocain.exchange.bean.SpringContext;
//import com.blocain.exchange.csrf.CSRFDataValueProcessor;
...
//public class CustomFormTag extends AbstractHtmlElementTag
//{
//    public static final CustomRequestProcessor processor                     = SpringContext.getBean(CSRFDataValueProcessor.class);
//
...
//        {
//            if (httpMethod.name().equalsIgnoreCase(method)) { return; }
//        }
...
//        if (resolvedModelAttribute == null) { throw new IllegalArgumentException(MODEL_ATTRIBUTE + " must not be null"); }
...
//
//    /**
//     * Process the action through a {@link CustomRequestProcessor} instance
...
//        if ((processor != null) && (request instanceof HttpServletRequest))
//        {
//            writeHiddenFields(processor.getExtraHiddenFields((HttpServletRequest) request, getId()));
//        }
