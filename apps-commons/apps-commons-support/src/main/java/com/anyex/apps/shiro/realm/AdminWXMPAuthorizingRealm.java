...
/**
 * <p>File：AdminWXMPAuthorizingRealm.java </p>
 * <p>Title: 系统安全认证实现类 </p>
 * <p>Description: AdminWXMPAuthorizingRealm </p>
...
@Slf4j
@Setter
public class AdminWXMPAuthorizingRealm extends AuthorizingRealm
{
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authToken) throws AuthenticationException
    {
        ...
        if (ListUtils.isNotNull(roles))
        {
            ...
            {
                // List<SysFrontModule> frontModules = frontModuleService.findByRoleId(role.getId());
                // role.setFrontModules(frontModules);
            }
        }
    ...
    protected boolean validGaCode(String authKey, String validCode)
    {
        ...
        com.anyex.apps.google.Authenticator authenticator = new Authenticator();
