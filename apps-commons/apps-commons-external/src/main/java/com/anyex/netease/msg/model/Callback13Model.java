...
@Data
public class Callback13Model {

    /**
     * https://doc.yunxin.163.com/messaging/docs/Tc5OTU0Nzk?platform=server#转让群回调
     */
    ...
    private String toAccount;// 对方账户
    private Boolean leave;// 操作者是否退群
