...
public class BinanceApiConstants {
   ...
   * REST API base URL.
   */
  public static final String API_BASE_URL = BinanceParameterConfig.binanceURL.API_BASE_URL;

  /**
   * Streaming API base URL.
   */
  public static final String WS_API_BASE_URL = BinanceParameterConfig.binanceURL.WS_API_BASE_URL;

  /**
   * Asset info base URL.
   */
  public static final String ASSET_INFO_API_BASE_URL = BinanceParameterConfig.binanceURL.ASSET_INFO_API_BASE_URL;
   ...
   */
  public static final long DEFAULT_RECEIVING_WINDOW = 3_000_000L;
