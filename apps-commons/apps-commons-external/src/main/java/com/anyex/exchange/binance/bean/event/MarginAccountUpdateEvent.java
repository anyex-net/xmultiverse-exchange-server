...
public class MarginAccountUpdateEvent {
  ...
  @JsonProperty("B")
  @JsonDeserialize(contentUsing = MarginAssetBalanceDeserializer.class)
  private List<UserAssets> balances;
  ...
  public List<UserAssets> getBalances() {
    return balances;
  }

  public void setBalances(List<UserAssets> balances) {
