...
import com.anyex.exchange.binance.client.BinanceApiError;
import com.anyex.exchange.binance.client.config.BinanceApiConfig;
import com.anyex.exchange.binance.client.exception.BinanceApiException;
import com.anyex.exchange.binance.client.security.AuthenticationInterceptor;
...
public class BinanceApiServiceGenerator {
    ...
    public static <S> S createDApiService(Class<S> serviceClass, String apiKey, String secret) {
        String baseUrl = null;
        if (!BinanceApiConfig.useTestnet) { baseUrl = BinanceApiConfig.getDApiBaseUrl(); }
        else {
            baseUrl = /*BinanceApiConfig.useTestnetStreaming ?
                BinanceApiConfig.getStreamTestNetBaseUrl() :*/
                    BinanceApiConfig.getTestNetBaseUrl();
    ...
    public static <S> S createFApiService(Class<S> serviceClass, String apiKey, String secret) {
        String baseUrl = null;
        if (!BinanceApiConfig.useTestnet) { baseUrl = BinanceApiConfig.getFApiBaseUrl(); }
        else {
            baseUrl = /*BinanceApiConfig.useTestnetStreaming ?
                BinanceApiConfig.getStreamTestNetBaseUrl() :*/
                    BinanceApiConfig.getTestNetBaseUrl();
