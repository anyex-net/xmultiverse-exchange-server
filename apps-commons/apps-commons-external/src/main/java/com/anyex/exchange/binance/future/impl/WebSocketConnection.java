...
import com.anyex.exchange.binance.future.SubscriptionOptions;
...
public class WebSocketConnection extends WebSocketListener
{
    ...
    WebSocketConnection(String apiKey, String secretKey, SubscriptionOptions options, WebsocketRequest request, WebSocketWatchDog watchDog)
    {
        this(apiKey, secretKey, options, request, watchDog, false);
    }
    
    WebSocketConnection(String apiKey, String secretKey, SubscriptionOptions options, WebsocketRequest request, WebSocketWatchDog watchDog, boolean autoClose)
    {
