...
import com.anyex.exchange.binance.client.exception.UnsupportedEventException;
...
public class UserDataUpdateEvent {
  ...
  public enum UserDataUpdateEventType {
    ...
    public static UserDataUpdateEventType fromEventTypeId(String eventTypeId) {
      if(StringUtils.equalsIgnoreCase(eventTypeId,"ACCOUNT_UPDATE") || StringUtils.equalsIgnoreCase(eventTypeId,"ORDER_TRADE_UPDATE"))
      {
        return FUTURES;
      }
