...
import com.anyex.exchange.binance.bean.event.*;
...
import com.anyex.exchange.binance.service.BinanceApiCallback;
import com.anyex.exchange.binance.service.BinanceApiWebSocketClient;
...
public class BinanceApiWebSocketClientImpl implements BinanceApiWebSocketClient, Closeable {
    ...
    public Closeable onMarginUserDataUpdateEvent(String listenKey, BinanceApiCallback<MarginUserDataUpdateEvent> callback) {
        return createNewWebSocket(listenKey, new BinanceApiWebSocketListener<>(callback, MarginUserDataUpdateEvent.class));
    }
