...
public interface BinanceApiWebSocketClient extends Closeable {
    ...
    Closeable onDApiUserDataUpdateEvent(String listenKey, BinanceApiCallback<UserDataUpdateEvent> callback);

    Closeable onFApiUserDataUpdateEvent(String listenKey, BinanceApiCallback<UserDataUpdateEvent> callback);
    ...
    Closeable onAllCoinContractMarketTickersEvent(BinanceApiCallback<List<TickerEvent>> callback);

    Closeable onAllUsdtContractMarketTickersEvent(BinanceApiCallback<List<TickerEvent>> callback);
