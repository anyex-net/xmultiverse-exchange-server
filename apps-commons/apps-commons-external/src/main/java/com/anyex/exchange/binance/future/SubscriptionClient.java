...
import com.anyex.exchange.binance.future.impl.BinanceApiInternalFactory;
import com.anyex.exchange.binance.future.model.enums.CandlestickInterval;
import com.anyex.exchange.binance.future.model.event.*;
import com.anyex.exchange.binance.future.model.user.UserDataUpdateEvent;

import java.util.List;


/***
 * The subscription future interface, it is used for subscribing any market data
 ...
 * future. if future get the update, the onReceive method will be called.
 */
public interface SubscriptionClient {
    /**
     * Create the subscription future to subscribe the update from server.
     *
     * @return The instance of synchronous future.
     */
     ...
     * server will send the data to future and onReceive in callback will be called.
     *
     ...
     *                     or error happen between future and Binance server.
     */
