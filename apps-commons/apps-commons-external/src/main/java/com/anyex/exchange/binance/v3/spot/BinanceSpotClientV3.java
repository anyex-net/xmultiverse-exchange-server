 ...
 */
public interface BinanceSpotClientV3
{
    // General endpoints
    /**
    ...
    JSONArray getSpotTradeFee(String symbol);
     ...
     * 获取全仓杠杆资产信息接口
     */
    JSONObject getCrossMarginAccount(Long recvWindow, Long timestamp);
    
    /**
     * 获取逐仓杠杆资产信息接口
     */
    JSONObject getFixedMarginAccount(String symbols, Long recvWindow, Long timestamp);
    
    /**
     * 杠杆交易下单接口
     */
    JSONObject newMarginOrder(NewOrder order);
    
    /**
     * 获取杠杆订单信息接口
     */
    JSONObject getMarginOrder(String symbol, String orderId, Long timestamp);
    
    /**
     * 取消杠杆订单接口
     */
    void cancelMarginOrder(String symbol, String orderId, Long timestamp);
}
