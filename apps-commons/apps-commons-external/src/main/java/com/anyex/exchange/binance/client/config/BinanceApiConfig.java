package com.anyex.exchange.binance.client.config;
...
public class BinanceApiConfig {
	...
	public static String getDApiStreamApiBaseUrl() {
		return String.format("wss://dstream.%s/ws", getBaseDomain());
	}

	public static String getFApiStreamApiBaseUrl() {
