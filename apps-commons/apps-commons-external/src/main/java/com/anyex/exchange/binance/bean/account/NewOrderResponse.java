...
import com.anyex.exchange.binance.bean.OrderStatus;
...
public class NewOrderResponse {
    ...
    public void setMsg(String symbol) {
        this.msg = msg;
    }
    ...
    public String toString() {
        ToStringBuilder stringBuilder = new ToStringBuilder(this, BinanceApiConstants.TO_STRING_BUILDER_STYLE)
                ...
                .append("side", side);
        if (fills != null) {
            stringBuilder.append("fills", fills.stream().map(Object::toString).collect(Collectors.joining(", ")));
        }
