...
import com.anyex.exchange.binance.client.BinanceApiAsyncRestClient;
import com.anyex.exchange.binance.client.BinanceApiCallback;
...
import com.anyex.exchange.binance.client.domain.account.Account;
import com.anyex.exchange.binance.client.domain.account.DepositAddress;
import com.anyex.exchange.binance.client.domain.account.DepositHistory;
import com.anyex.exchange.binance.client.domain.account.NewOrder;
import com.anyex.exchange.binance.client.domain.account.NewOrderResponse;
import com.anyex.exchange.binance.client.domain.account.Order;
import com.anyex.exchange.binance.client.domain.account.Trade;
import com.anyex.exchange.binance.client.domain.account.TradeHistoryItem;
import com.anyex.exchange.binance.client.domain.account.WithdrawHistory;
import com.anyex.exchange.binance.client.domain.account.WithdrawResult;
import com.anyex.exchange.binance.client.domain.account.request.AllOrdersRequest;
import com.anyex.exchange.binance.client.domain.account.request.CancelOrderRequest;
import com.anyex.exchange.binance.client.domain.account.request.CancelOrderResponse;
import com.anyex.exchange.binance.client.domain.account.request.OrderRequest;
import com.anyex.exchange.binance.client.domain.account.request.OrderStatusRequest;
import com.anyex.exchange.binance.client.domain.event.ListenKey;
...
import com.anyex.exchange.binance.client.domain.general.ServerTime;
import com.anyex.exchange.binance.client.domain.market.AggTrade;
import com.anyex.exchange.binance.client.domain.market.BookTicker;
import com.anyex.exchange.binance.client.domain.market.Candlestick;
import com.anyex.exchange.binance.client.domain.market.CandlestickInterval;
import com.anyex.exchange.binance.client.domain.market.OrderBook;
import com.anyex.exchange.binance.client.domain.market.TickerPrice;
import com.anyex.exchange.binance.client.domain.market.TickerStatistics;

import java.util.List;

import static com.anyex.exchange.binance.client.impl.BinanceApiServiceGenerator.createService;
