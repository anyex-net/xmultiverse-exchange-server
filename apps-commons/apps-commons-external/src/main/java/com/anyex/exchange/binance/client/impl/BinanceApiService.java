...
import com.anyex.exchange.binance.client.domain.OrderSide;
import com.anyex.exchange.binance.client.domain.OrderType;
import com.anyex.exchange.binance.client.domain.SwapRemoveType;
import com.anyex.exchange.binance.client.domain.TimeInForce;
import com.anyex.exchange.binance.client.domain.account.*;
import com.anyex.exchange.binance.client.domain.account.request.CancelOrderListResponse;
...
public interface BinanceApiService {
    ...
    Call<ListenKey> startMarginIsolatedUserDataStream(@Query("symbol") String symbol);

    @Headers(BinanceApiConstants.ENDPOINT_SECURITY_TYPE_APIKEY_HEADER)
    @PUT("/sapi/v1/userDataStream/isolated")
    Call<Void> keepAliveMarginIsolatedUserDataStream(@Query("listenKey") String listenKey,@Query("symbol") String symbol);

    @Headers(BinanceApiConstants.ENDPOINT_SECURITY_TYPE_APIKEY_HEADER)
    @DELETE("/sapi/v1/userDataStream/isolated")
    Call<Void> closeMarginIsolatedAliveUserDataStream(@Query("listenKey") String listenKey,@Query("symbol") String symbol);

    @Headers(BinanceApiConstants.ENDPOINT_SECURITY_TYPE_APIKEY_HEADER)
    @POST("/dapi/v1/listenKey")
    Call<ListenKey> startCoinContractUserDataStream();

    @Headers(BinanceApiConstants.ENDPOINT_SECURITY_TYPE_APIKEY_HEADER)
    @PUT("/dapi/v1/listenKey")
    Call<Void> keepAliveCoinContractUserDataStream(@Query("listenKey") String listenKey);

    @Headers(BinanceApiConstants.ENDPOINT_SECURITY_TYPE_APIKEY_HEADER)
    @DELETE("/dapi/v1/listenKey")
    Call<Void> closeCoinContractAliveUserDataStream(@Query("listenKey") String listenKey);

    @Headers(BinanceApiConstants.ENDPOINT_SECURITY_TYPE_APIKEY_HEADER)
    @POST("/fapi/v1/listenKey")
    Call<ListenKey> startUsdtContractUserDataStream();

    @Headers(BinanceApiConstants.ENDPOINT_SECURITY_TYPE_APIKEY_HEADER)
    @PUT("/fapi/v1/listenKey")
    Call<Void> keepAliveUsdtContractUserDataStream(@Query("listenKey") String listenKey);

    @Headers(BinanceApiConstants.ENDPOINT_SECURITY_TYPE_APIKEY_HEADER)
    @DELETE("/fapi/v1/listenKey")
    Call<Void> closeUsdtContractAliveUserDataStream(@Query("listenKey") String listenKey);
