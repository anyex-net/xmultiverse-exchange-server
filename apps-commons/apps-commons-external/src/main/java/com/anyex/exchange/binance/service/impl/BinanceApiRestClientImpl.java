...
import com.anyex.exchange.binance.service.BinanceApiRestClient;
...
public class BinanceApiRestClientImpl implements BinanceApiRestClient {
    ...
    public MarginAccount getMarginAccount(Long recvWindow, Long timestamp) {
        return executeSync(binanceApiService.getMarginAccount(recvWindow,timestamp));
    }
    ...
    public void keepMarginAliveUserDataStream(String listenKey) {
        executeSync(binanceApiService.keepMarginAliveUserDataStream(listenKey));
    }
