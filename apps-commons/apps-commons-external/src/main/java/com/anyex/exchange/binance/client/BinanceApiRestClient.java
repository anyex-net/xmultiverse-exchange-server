...
public interface BinanceApiRestClient {
   ...
   * @return a listen key that can be used with data streams
   */
  String startMarginIsolatedUserDataStream(String symbol);
   ...
   * @param listenKey listen key that identifies a data stream
   */
  void keepMarginIsolatedAliveUserDataStream(String listenKey,String symbol);
   ...
   * @param listenKey listen key that identifies a data stream
   */
  void closeMarginIsolatedUserDataStream(String listenKey,String symbol);
   ...
   * @return a listen key that can be used with data streams
   */
  String startCoinContractUserDataStream();
   ...
   * @param listenKey listen key that identifies a data stream
   */
  void keepCoinContractAliveUserDataStream(String listenKey);
   ...
   * @param listenKey listen key that identifies a data stream
   */
  void closeCoinContractUserDataStream(String listenKey);
   ...
   * @return a listen key that can be used with data streams
   */
  String startUsdtContractUserDataStream();
   ...
   * @param listenKey listen key that identifies a data stream
   */
  void keepUsdtContractAliveUserDataStream(String listenKey);
   ...
   * @param listenKey listen key that identifies a data stream
   */
  void closeUsdtContractUserDataStream(String listenKey);
}
