package com.anyex.exchange.binance.client.impl;

import com.anyex.exchange.binance.client.BinanceApiRestClient;
import com.anyex.exchange.binance.client.config.BinanceApiConfig;
import com.anyex.exchange.binance.client.constant.BinanceApiConstants;
import com.anyex.exchange.binance.client.domain.account.*;
import com.anyex.exchange.binance.client.domain.account.request.*;
import com.anyex.exchange.binance.client.domain.general.Asset;
import com.anyex.exchange.binance.client.domain.general.ExchangeInfo;
import com.anyex.exchange.binance.client.domain.market.*;
import retrofit2.Call;

import java.util.List;

import static com.anyex.exchange.binance.client.impl.BinanceApiServiceGenerator.*;
import static com.anyex.exchange.binance.client.impl.BinanceApiServiceGenerator.createFApiService;
...
public class BinanceApiRestClientImpl implements BinanceApiRestClient {
	...
	private final BinanceApiService binanceDApiService;

	private final BinanceApiService binanceFApiService;

	public BinanceApiRestClientImpl(String apiKey, String secret) {
		binanceApiService = createService(BinanceApiService.class, apiKey, secret);
		binanceDApiService = createDApiService(BinanceApiService.class, apiKey, secret);
		binanceFApiService = createFApiService(BinanceApiService.class, apiKey, secret);
	}
	...
	public void closeMarginUserDataStream(String listenKey) {
		executeSync(binanceApiService.closeMarginAliveUserDataStream(listenKey));
	}

	@Override
	public String startMarginIsolatedUserDataStream(String symbol) {
		return executeSync(binanceApiService.startMarginIsolatedUserDataStream(symbol)).toString();
	}

	@Override
	public void keepMarginIsolatedAliveUserDataStream(String listenKey,String symbol) {
		executeSync(binanceApiService.keepAliveMarginIsolatedUserDataStream(listenKey,symbol));
	}

	@Override
	public void closeMarginIsolatedUserDataStream(String listenKey,String symbol) {
		executeSync(binanceApiService.closeMarginIsolatedAliveUserDataStream(listenKey,symbol));
	}

	@Override
	public String startCoinContractUserDataStream() {
		return executeSync(binanceDApiService.startCoinContractUserDataStream()).toString();
	}

	@Override
	public void keepCoinContractAliveUserDataStream(String listenKey) {
		executeSync(binanceDApiService.keepAliveCoinContractUserDataStream(listenKey));
	}

	@Override
	public void closeCoinContractUserDataStream(String listenKey) {
		executeSync(binanceDApiService.closeCoinContractAliveUserDataStream(listenKey));
	}

	@Override
	public String startUsdtContractUserDataStream() {
		return executeSync(binanceFApiService.startUsdtContractUserDataStream()).toString();
	}

	@Override
	public void keepUsdtContractAliveUserDataStream(String listenKey) {
		executeSync(binanceFApiService.keepAliveUsdtContractUserDataStream(listenKey));
	}

	@Override
	public void closeUsdtContractUserDataStream(String listenKey) {
		executeSync(binanceFApiService.closeUsdtContractAliveUserDataStream(listenKey));
	}
