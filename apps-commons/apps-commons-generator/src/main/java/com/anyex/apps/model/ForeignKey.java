...
import com.anyex.apps.utils.ListHashtable;
...
public class ForeignKey
{
    ...
    private void initRelationship()
    {
        ...
        if (null != parentPrimaryKeys && hasAllPrimaryKeys(parentPrimaryKeys, parentColumns)) // sun
        {
            firstRelation = "one";
        }
        else
        ...
        if (null != foreignPrimaryKeys && hasAllPrimaryKeys(foreignPrimaryKeys, columns)) // sun
        {
            secondRelation = "one";
        }
        else
