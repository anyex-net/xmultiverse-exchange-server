...
import com.anyex.apps.controller.auth.reqnew.ReqCheckEmailNew;
import com.anyex.apps.controller.auth.reqnew.ReqEmailResetpassNew;
...
//        }
    ...
    public JsonMessage checkEmail(HttpServletRequest request, @RequestBody ReqCheckEmailNew reqCheckEmail) throws BusinessException
    {
        JsonMessage json = this.getJsonMessage(CommonEnums.SUCCESS);
        //
    ...
    public JsonMessage emailResetPass(HttpServletRequest request, @RequestBody ReqEmailResetpassNew reqEmailResetpass) throws BusinessException
    {
        //
        String ip = NetworkUtils.getIpAddr(request);
        String cacheKey = new StringBuffer(CacheConst.FIND_PASSWD_PERFIX)// 加入缓存前缀
