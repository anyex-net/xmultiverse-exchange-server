...
/**
 * RWA机构SPV产品赎回记录 实体请求对象
 * <p>File：ReqRwaInstSpvProductRedemption.java</p>
 * <p>Title: ReqRwaInstSpvProductRedemption</p>
 * <p>Description:ReqRwaInstSpvProductRedemption</p>
...
@ApiModel(description = "RWA机构SPV产品赎回记录请求对象")
public class ReqRwaInstSpvProductRedemption extends GenericEntity
{
	...
	/**赎回币种*/
	@NotEmpty(message = "赎回币种不可为空")
	@ApiModelProperty(value = "赎回币种", position = 4, required = true)
	private java.lang.String redemptionCurrency;

	/**赎回价格*/
	@NotNull(message = "赎回价格不可为空")
	@ApiModelProperty(value = "赎回价格", position = 5, required = true)
	private java.math.BigDecimal redemptionPrice;

	/**赎回数量*/
	@NotNull(message = "赎回数量不可为空")
	@ApiModelProperty(value = "赎回数量", position = 6, required = true)
