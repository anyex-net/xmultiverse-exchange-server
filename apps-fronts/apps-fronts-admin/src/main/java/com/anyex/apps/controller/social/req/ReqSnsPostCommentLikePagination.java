...
/**
 * 社交帖子评论点赞 分页请求对象
 * <p>File：ReqSnsPostCommentLike.java</p>
 * <p>Title: ReqSnsPostCommentLike</p>
 * <p>Description:ReqSnsPostCommentLike</p>
...
@ApiModel(description = "社交帖子评论点赞分页请求对象")
public class ReqSnsPostCommentLikePagination extends Pagination
{
