...
public class RwaInstSpvProductDividendController extends GenericController
{
    ...
    public JsonMessage<RwaInstSpvProductDividend> findBy(Long id) throws BusinessException
    {
    ...
    public JsonMessage<PaginateResult<RwaInstSpvProductDividend>> data(@ModelAttribute ReqRwaInstSpvProductDividendPagination pagin) throws BusinessException
    {
