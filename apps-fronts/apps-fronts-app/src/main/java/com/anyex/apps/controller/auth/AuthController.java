...
import com.anyex.apps.controller.auth.req.ReqAccountToken;
...
public class AuthController extends GenericController
{
    ...
    public JsonMessage login(HttpServletRequest request, @RequestBody ReqAccountToken reqAccountToken) throws BusinessException
    {
