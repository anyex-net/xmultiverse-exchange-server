...
@Slf4j
@RestController
@RequestMapping(GlobalConst.IM+"/old/user")
@Api(tags = "用户服务")
public class OpenImChatUserController extends GenericController
{
    ...
    public OpenImResult<String> updateUserInfo(@Validated @RequestBody UpdateUserInfoReq req) throws BusinessException
    {
        ...
        OpenImResult<String> openImResult = new OpenImResult<>();
    ...
    public OpenImResult<FindUserFullInfoResp> findFull(@Validated @RequestBody FindUserFullInfoReq req) throws BusinessException
    {
        ValidatorUtils.validate(req);
        UserPrincipal principal = OnLineUserUtils.getPrincipal();
        if (null == principal)
        ...
        OpenImResult<FindUserFullInfoResp> openImResult = new OpenImResult<>();
        openImResult.success();
        openImResult.setData(rest);
        return openImResult;
    }

    @PostMapping(value = "/find/public")
    @ApiOperation(value = "获取用户公开信息", httpMethod = "POST")
    public OpenImResult<FindUserPublicInfoResp> findPublic(@Validated @RequestBody FindUserPublicInfoReq req) throws BusinessException
    {
        ValidatorUtils.validate(req);
        UserPrincipal principal = OnLineUserUtils.getPrincipal();
        if (null == principal)
        ...
        OpenImResult<FindUserPublicInfoResp> openImResult = new OpenImResult<>();
        openImResult.success();
        openImResult.setData(rest);
        return openImResult;
    }
    ...
    public OpenImResult<SearchUserFullInfoResp> searchFull(@Validated @RequestBody SearchUserFullInfoReq req) throws BusinessException
    {
        ValidatorUtils.validate(req);
        UserPrincipal principal = OnLineUserUtils.getPrincipal();
        if (null == principal)
        ...
        OpenImResult<SearchUserFullInfoResp> openImResult = new OpenImResult<>();
        openImResult.success();
        openImResult.setData(rest);
        return openImResult;
    }
    ...
    public OpenImResult<SearchUserPubliclInfoResp> searchPublic(@Validated @RequestBody com.anyex.apps.openim.chat.user.req.SearchUserPublicInfoReq req) throws BusinessException
    {
        ValidatorUtils.validate(req);
        UserPrincipal principal = OnLineUserUtils.getPrincipal();
        if (null == principal)
        ...
        OpenImResult<SearchUserPubliclInfoResp> openImResult = new OpenImResult<>();
        openImResult.success();
        openImResult.setData(rest);
        return openImResult;
    }
    ...
    public OpenImResult<LiveKitTokenResp> rtc(@Validated @RequestBody com.anyex.apps.openim.chat.user.req.LiveKitTokenReq req) throws BusinessException
    {
...
//        RoomJoin:加入房间许可   Room：房间名称
      ...
      //  return token.toJwt();
        ...
        OpenImResult<LiveKitTokenResp> openImResult = new OpenImResult<>();
        openImResult.success();
