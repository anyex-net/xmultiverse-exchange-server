...
//    }
    ...
    @Bean
    public Docket app_api_operation() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(new ApiInfoBuilder()
                        .title("运营管理API")
                        .description("运营管理")
...
//    @Bean
//    public Docket app_api_business_luckybox_shop() {
//        return new Docket(DocumentationType.SWAGGER_2)
//                .apiInfo(new ApiInfoBuilder()
...
//    }
    ...
    @Bean
    public Docket app_api_business_luckybox_goods() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(new ApiInfoBuilder()
    ...
    @Bean
    public Docket app_api_business_luckybox_activity() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(new ApiInfoBuilder()
    ...
    @Bean
    public Docket app_api_business_luckybox_game() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(new ApiInfoBuilder()
    ...
    @Bean
    public Docket app_api_business_luckybox_order() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(new ApiInfoBuilder()
