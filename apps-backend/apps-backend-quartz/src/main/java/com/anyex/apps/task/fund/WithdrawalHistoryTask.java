            ...
            try {
                ...
                if(null != jsonObjectResp && "0".equals(jsonObjectResp.getString("code")))
                {
                    ...
                    if(null != jsonArray && jsonArray.size() > 0)
                    {
                        ...
                        RwaInstSpvProductDividend rwaInstSpvProductDividendSearch = new RwaInstSpvProductDividend();
                        ...
                        for(int i=0; i<jsonArray.size(); i++) {
                            ...
                            //
                            //
                            rwaInstSpvProductDividendSearch.setRemark(jsonObject.getString("request_no"));
                            RwaInstSpvProductDividend rwaInstSpvProductDividendDB = rwaInstSpvProductDividendService.selectOne(rwaInstSpvProductDividendSearch);
                            if(null != rwaInstSpvProductDividendDB){
                                ...
                                log.error("对应的RWA机构SPV产品分红记录记录不存在，无需执行！");
                            }
                        }
                    }
                } else {
