...
//
//    @Value("${com.blocain.email.withdrawal.username}")
//    private String               username;
//
//    @Value("${com.blocain.email.withdrawal.personal}")
//    private String               personal;
//
//    @Autowired
//    private JavaMailSender       withdrawalSender;
//
...
//    {
//        message = withdrawalSender.createMimeMessage();
