...
/**
 * RWA机构SPV产品 实体对象
 * <p>File：RwaInstSpvProduct.java</p>
 * <p>Title: RwaInstSpvProduct</p>
 * <p>Description:RwaInstSpvProduct</p>
...
@ApiModel(description = "RWA机构SPV产品")
public class RwaInstSpvProduct extends GenericEntity
{
	...
	@ApiModelProperty(value = "代币名称", position = 6, required = true)
	private String tokenName;

	/**代币Logo*/
	@NotEmpty(message = "代币Logo不可为空")
	@ApiModelProperty(value = "代币Logo", position = 7, required = true)
	private String tokenLogo;

	/**代币发行数量*/
	@NotNull(message = "代币发行数量不可为空")
	@ApiModelProperty(value = "代币发行数量", position = 8, required = true)
	private java.math.BigDecimal tokenIssueNumber;

	/**募集币种*/
	@NotEmpty(message = "募集币种不可为空")
	@ApiModelProperty(value = "募集币种", position = 9, required = true)
	private String raiseCurrency;

	/**募集金额*/
	@NotNull(message = "募集金额不可为空")
	@ApiModelProperty(value = "募集金额", position = 10, required = true)
	private java.math.BigDecimal raiseAmount;

	/**资产期末估值, 预估收益率=(期末估值-募集金额)/募集金额*/
	@NotNull(message = "资产期末估值, 预估收益率=(期末估值-募集金额)/募集金额不可为空")
	@ApiModelProperty(value = "资产期末估值, 预估收益率=(期末估值-募集金额)/募集金额", position = 11, required = true)
	private java.math.BigDecimal assetEndValuation;

	/**发行天数*/
	@NotNull(message = "发行天数不可为空")
	@ApiModelProperty(value = "发行天数", position = 12, required = true)
	private Integer issueDays;

	/**申购开始日期*/
	@NotNull(message = "申购开始日期不可为空")
	@ApiModelProperty(value = "申购开始日期", position = 13, required = true)
	private java.util.Date purchaseStartDate;

	/**申购结束日期*/
	@NotNull(message = "申购结束日期不可为空")
	@ApiModelProperty(value = "申购结束日期", position = 14, required = true)
	private java.util.Date purchaseEndDate;

	/**运营开始日期*/
	@NotNull(message = "运营开始日期不可为空")
	@ApiModelProperty(value = "运营开始日期", position = 15, required = true)
	private java.util.Date operationStarDate;

	/**运营结束日期*/
	@NotNull(message = "运营结束日期不可为空")
	@ApiModelProperty(value = "运营结束日期", position = 16, required = true)
	private java.util.Date operationEndDate;

	/**募集成立条件比例*/
	@NotNull(message = "募集成立条件比例不可为空")
	@ApiModelProperty(value = "募集成立条件比例", position = 17, required = true)
	private java.math.BigDecimal raiseEstablishedRatio;

	/**公司资产名称*/
	@NotEmpty(message = "公司资产名称不可为空")
	@ApiModelProperty(value = "公司资产名称", position = 18, required = true)
	private String companyAssetName;

	/**公司资产描述*/
	@NotEmpty(message = "公司资产描述不可为空")
	@ApiModelProperty(value = "公司资产描述", position = 19, required = true)
	private String companyAssetDesc;

	/**公司募集用途*/
	@NotEmpty(message = "公司募集用途不可为空")
	@ApiModelProperty(value = "公司募集用途", position = 20, required = true)
	private String companyRaiseUse;

	/**代币合约地址*/
	@ApiModelProperty(value = "代币合约地址", position = 21)
	private String tokenContractAddress;

	/**分润合约地址*/
	@ApiModelProperty(value = "分润合约地址", position = 22)
	private String shareContractAddress;

	/**分红比例*/
	@NotNull(message = "分红比例不可为空")
	@ApiModelProperty(value = "分红比例", position = 23, required = true)
	...
	@ApiModelProperty(value = "募集对应保证金状态(0未缴、1已缴)", position = 28, required = true)
	...
	@NotEmpty(message = "状态(0未审核、1审核通过、2审核拒绝、3合约部署中、4待开放、5申购中、6发行失败、7运营中、8已到期、9待运营)不可为空")
