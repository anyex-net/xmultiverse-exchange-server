...
/**
 * 用户认证个人KYC 实体对象
 * <p>File：UserCertKyc.java</p>
 * <p>Title: UserCertKyc</p>
 * <p>Description:UserCertKyc</p>
...
@ApiModel(description = "用户认证个人KYC")
public class UserCertKyc extends GenericEntity
{
	...
	/**状态(0未审核、1审核通过、2审核拒绝)*/
	@NotNull(message = "状态(0未审核、1审核通过、2审核拒绝)不可为空")
	@ApiModelProperty(value = "状态(0未审核、1审核通过、2审核拒绝)", position = 10, required = true)
