...
/**
 * 平台交易产品币种信息 实体对象
 * <p>File：InstrumentsCurrency.java</p>
 * <p>Title: InstrumentsCurrency</p>
 * <p>Description:InstrumentsCurrency</p>
...
@ApiModel(description = "平台交易产品币种信息")
public class InstrumentsCurrency extends GenericEntity
{
	...
	private java.lang.String currencyNum;

	/**资产合约*/
	@NotEmpty(message = "资产合约不可为空")
	@ApiModelProperty(value = "资产合约", position = 7, required = true)
	private java.lang.String currencyContract;
