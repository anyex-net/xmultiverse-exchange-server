...
/**
 * 用户持有数量奖励配置 实体对象
 * <p>File：UserHoldAmountRewardConfig.java</p>
 * <p>Title: UserHoldAmountRewardConfig</p>
 * <p>Description:UserHoldAmountRewardConfig</p>
...
@ApiModel(description = "用户持有数量奖励配置")
public class UserHoldAmountRewardConfig extends GenericEntity
{
