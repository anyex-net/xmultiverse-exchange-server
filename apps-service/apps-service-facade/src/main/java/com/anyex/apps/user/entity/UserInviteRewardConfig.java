...
/**
 * 用户邀请返佣奖励配置 实体对象
 * <p>File：UserInviteRewardConfig.java</p>
 * <p>Title: UserInviteRewardConfig</p>
 * <p>Description:UserInviteRewardConfig</p>
...
@ApiModel(description = "用户邀请返佣奖励配置")
public class UserInviteRewardConfig extends GenericEntity
{
