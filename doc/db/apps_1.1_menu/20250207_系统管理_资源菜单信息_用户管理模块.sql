...
INSERT INTO SysResources (id, parentId, resCode, resName, resDest, type, icon, sortNum, resShortUrl, resUrl, createBy, createDate, updateBy, updateDate)
VALUES (310000000012, 310000000001, 'user:userApi:index', '用户API', null, false, 'Icon30n', 4, 'userApi', '/user/userApi', 200000000000, 1501467844534, 200000000000, 1501467844534);
INSERT INTO SysResources (id, parentId, resCode, resName, resDest, type, icon, sortNum, resShortUrl, resUrl, createBy, createDate, updateBy, updateDate)
VALUES (310000000013, 310000000012, 'user:userApi:operator', '操作权限', null, true, null, null, 'userApi', '#', 200000000000, 1501467844534, 200000000000, 1501467844534);
INSERT INTO SysResources (id, parentId, resCode, resName, resDest, type, icon, sortNum, resShortUrl, resUrl, createBy, createDate, updateBy, updateDate)
VALUES (310000000014, 310000000012, 'user:userApi:data', '查询权限', null, true, null, null, 'userApi', '#', 200000000000, 1501467844534, 200000000000, 1501467844534);

INSERT INTO SysResources (id, parentId, resCode, resName, resDest, type, icon, sortNum, resShortUrl, resUrl, createBy, createDate, updateBy, updateDate)
VALUES (310000000015, 310000000001, 'user:userHoldAmountRewardConfig:index', '用户持有数量奖励配置', null, false, 'Icon30n', 5, 'userHoldAmountRewardConfig', '/user/userHoldAmountRewardConfig', 200000000000, 1501467844534, 200000000000, 1501467844534);
INSERT INTO SysResources (id, parentId, resCode, resName, resDest, type, icon, sortNum, resShortUrl, resUrl, createBy, createDate, updateBy, updateDate)
VALUES (310000000016, 310000000015, 'user:userHoldAmountRewardConfig:operator', '操作权限', null, true, null, null, 'userHoldAmountRewardConfig', '#', 200000000000, 1501467844534, 200000000000, 1501467844534);
INSERT INTO SysResources (id, parentId, resCode, resName, resDest, type, icon, sortNum, resShortUrl, resUrl, createBy, createDate, updateBy, updateDate)
VALUES (310000000017, 310000000015, 'user:userHoldAmountRewardConfig:data', '查询权限', null, true, null, null, 'userHoldAmountRewardConfig', '#', 200000000000, 1501467844534, 200000000000, 1501467844534);

INSERT INTO SysResources (id, parentId, resCode, resName, resDest, type, icon, sortNum, resShortUrl, resUrl, createBy, createDate, updateBy, updateDate)
VALUES (310000000018, 310000000001, 'user:userInviteRewardConfig:index', '用户邀请返佣奖励配置', null, false, 'Icon30n', 6, 'userInviteRewardConfig', '/user/userInviteRewardConfig', 200000000000, 1501467844534, 200000000000, 1501467844534);
INSERT INTO SysResources (id, parentId, resCode, resName, resDest, type, icon, sortNum, resShortUrl, resUrl, createBy, createDate, updateBy, updateDate)
VALUES (310000000019, 310000000018, 'user:userInviteRewardConfig:operator', '操作权限', null, true, null, null, 'userInviteRewardConfig', '#', 200000000000, 1501467844534, 200000000000, 1501467844534);
INSERT INTO SysResources (id, parentId, resCode, resName, resDest, type, icon, sortNum, resShortUrl, resUrl, createBy, createDate, updateBy, updateDate)
